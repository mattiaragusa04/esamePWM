...
async function popolaDatabaseCategoriaElettronica() {
    try {
        ...
        const values = [
            ...
            ['Cuffie Bluetooth JBL On-Ear', 'Bassi potenti e suono inconfondibile JBL. Cuffie wireless leggere e pieghevoli, con una batteria a lunghissima durata per accompagnarti tutto il giorno.', 20, 'http://localhost:3000/public/immagini/elettronica/trasferimento (2).webp', 49.99, 1, 'Nuovo', Math.round(49.99 / 5)],

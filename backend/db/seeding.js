...
async function popolaDatabaseCategoriaConsole() {
    try {
        const response = 'INSERT INTO prodotto (categoria_id, nome, descrizione, giacenza, immagine, PrezzoUnitarioVendita, visibile, condizione, puntiFedelta) VALUES (1, ?, ?, ?, ?, ?, ?, ?, ?)';
        const values = [
...
async function popolaDatabaseCategoriaVideogiochi() {
    try {
        const response = 'INSERT INTO prodotto (categoria_id, nome, descrizione, giacenza, immagine, PrezzoUnitarioVendita, visibile, genere, condizione, puntiFedelta) VALUES (2, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
        const values = [
...
async function popolaDatabaseCategoriaAccessori() {
    try {
        const response = 'INSERT INTO prodotto (categoria_id, nome, descrizione, giacenza, immagine, PrezzoUnitarioVendita, visibile, condizione, puntiFedelta) VALUES (3, ?, ?, ?, ?, ?, ?, ?, ?)';
        const values = [
...
async function popolaDatabaseCategoriaElettronica() {
    try {
        const response = 'INSERT INTO prodotto (categoria_id, nome, descrizione, giacenza, immagine, PrezzoUnitarioVendita, visibile, condizione, puntiFedelta) VALUES (4, ?, ?, ?, ?, ?, ?, ?, ?)';
        const values = [

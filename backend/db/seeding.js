...
async function popolaDatabaseCategoriaConsole() {
    try {
        const response = 'INSERT INTO prodotto (categoria_id, nome, descrizione, giacenza, immagine, prezzoUnitarioVendita, pubblicatoVetrina, condizione) VALUES (1, ?, ?, ?, ?, ?, ?, ?)';
        const values = [
            ['Console PlayStation 5', 'Vivi un\'esperienza di gioco senza limiti con caricamenti fulminei grazie all\'SSD da 1TB e un coinvolgimento totale grazie al feedback aptico e all\'audio 3D.', 20, 'http://localhost:3000/public/immagini/console/ps5.png', 449.99, 1, 'Nuovo'],
            ['Console PlayStation 4', 'La console che ha definito una generazione. Goditi un vasto catalogo di capolavori e le migliori esclusive PlayStation con 500GB di archiviazione. ', 20, 'http://localhost:3000/public/immagini/console/SONY-Console-Sony-PS4-Chassis-B-500-GB--GTA-V-bundle.jpg', 249.99, 1, 'Usato'],
            ['Console Nintendo Switch OLED Lite', 'Il connubio perfetto tra portabilità estrema e uno schermo vibrante. Gioca ovunque senza compromessi visivi con questa edizione speciale.', 20, 'http://localhost:3000/public/immagini/console/nintendo_switch_lite.png', 399.99, 1, 'Nuovo'],
            ['Console Xbox Series X', 'La Xbox più veloce e potente di sempre. Esplora nuovi mondi con 12 teraflop di potenza grafica, ray tracing e puro gaming in 4K.', 20, 'http://localhost:3000/public/immagini/console/xbox_series_x.png', 499.99, 1, 'Nuovo'],
            ['Console PlayStation 5 Slim', 'Tutta la potenza next-gen di PS5 racchiusa in un design più sottile ed elegante. Prestazioni straordinarie con 1TB di archiviazione SSD ultra-veloce.', 20, 'http://localhost:3000/public/immagini/console/ps5_slim.png', 499.99, 1, 'Nuovo'],
            ['Console PlayStation 4 Slim', 'Design snello e compatto con la stessa incredibile potenza di gioco. Silenziosa ed elegante, la porta d\'accesso a migliaia di fantastici titoli.', 20, 'http://localhost:3000/public/immagini/console/SONY-Console-Sony-PS4-Slim-1-TB--Uncharted-4--Tomb-Raider-bundle.jpg', 299.99, 1, 'Usato'],
            ['Console Nintendo Switch OLED', 'Gioca a casa sulla TV o in viaggio con uno splendido schermo OLED da 7 pollici che offre colori intensi e un contrasto elevato.', 20, 'http://localhost:3000/public/immagini/console/nintendo_switch.png', 399.99, 1, 'Nuovo'],
            ['Console Xbox Series S', 'Prestazioni next-gen nella Xbox più piccola di sempre. Passa al digitale e goditi velocità fulminee e tempi di caricamento azzerati.', 20, 'http://localhost:3000/public/immagini/console/xbox_series_s.png', 499.99, 1, 'Nuovo'],
            ['Console Nintendo Switch OLED', 'Lo schermo OLED con colori mozzafiato, ora in versione usata in ottime condizioni per goderti il gaming ibrido al miglior prezzo.', 20, 'http://localhost:3000/public/immagini/console/nintendo_switch.png', 299.99, 1, 'Usato'],
            ['Console Nintendo Switch 2', 'Il futuro del gaming ibrido è qui. Prestazioni rivoluzionarie e nuove modalità di interazione per la prossima evoluzione di casa Nintendo.', 20, 'http://localhost:3000/public/immagini/console/nintendo_switch_2.png', 449.99, 1, 'Nuovo'],
            ['Console PlayStation 5 pro', 'Porta il gaming su console a un livello superiore. Framerate altissimi, ray tracing avanzato e grafica inarrivabile per i gamer più esigenti.', 20, 'http://localhost:3000/public/immagini/console/ps5_pro.png', 499.99, 1, 'Nuovo'],
            ['Console PlayStation 4 pro', 'Il potenziamento per i gamer appassionati. Goditi giochi in 4K dinamico e framerate stabile per un\'esperienza visiva spettacolare da 1TB.', 20, 'http://localhost:3000/public/immagini/console/ps4_pro.png', 349.99, 1, 'Usato'],
            ['Console Xbox One X', 'L\'ammiraglia della scorsa generazione per il vero gaming in 4K. Rivivi i classici e i grandi titoli con la massima qualità grafica possibile.', 20, 'http://localhost:3000/public/immagini/console/xbox-one-x-1tb-tom-clancys-the-division-2-bundle-586175.1.webp', 249.99, 1, 'Usata'],
        ]
